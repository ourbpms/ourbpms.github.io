...
urlpatterns = [
    ...
    url(r'^updatedpatprof', views.UpdatedPatientProfile, name='updatedpatprof'), ## updated patientprofile
    url(r'chart', views.Chart, name='chart'), ## bp chart
    url(r'^notif', views.notif, name='notif'),
    url(r'^vform', views.ViewPatient, name="inpFCred"),
    url(r'^verify', views.PatientList, name="inpCred"),
    url(r'^patientlist', views.PatientList2, name="inpCred2"),
